    ...
    foreach($_POST['checkBoxArray'] as $postValueId)
    {
       ...
       switch($bulk_options) {
           ...
           case 'clone':
               ...
               $query .= "VALUES({$post_category_id},'{$post_title}','{$post_author}',now(),'{$post_status}','{$post_image}','{$post_tags}',
    '{$post_content}' ) ";
...
if (isset($_GET['delete']))
{
        ...
        header("Location:posts.php"); // click once for the change to take place
}
