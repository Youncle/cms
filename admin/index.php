                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            <?php
                              ...
                              $element_text = ['Active Posts','Draft Posts', 'Approved Comments','Pending Comments', 'Admin Users',' Subscriber Users',  'Categories'];
                                $element_count = [$post_published_count,$post_draft_count, $comments_approved_count,$comments_unapproved_count, $user_admin_count,$user_subscriber_count, $categories_count];
